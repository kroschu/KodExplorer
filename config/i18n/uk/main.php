...
return array(
    ...
    "need_check_code_desc"           => "Вимагати код підтвердження.",
    "setting_csrf_protect"           => "Захистити від CSRF атак",
    ...
    "setting_show_root_group_desc"   => "Дерево каталогу кореневого слід перерахувати",
    ...
    "setting_global_css"             => "Призначені для користувача  CSS",
    "setting_global_css_desc"        => "Всі сторінки будуть вмати призначені для користувача CSS",
    "setting_global_html"            => "Статичний код HTML",
    "setting_global_html_desc"       => "Увсі сторінки буде встановлено цей код",
    "us"                             => "kodcloud.com",
    ...
    "ui_login"                       => "Зайти",
    "ui_logout"                      => "Вийти",
    "setting"                        => "Основні параметри",
    "setting_title"                  => "Лаштунки",
    "setting_user"                   => "Персональні параметри",
    ...
    "button_not_save"                => "Не зберігати",
    "button_add"                     => "Додати",
    "button_back_add"                => "Відмінити",
    "button_del"                     => "Видалити",
    "button_save_edit"               => "зберегти зміни",
    "button_save_submit"             => "Зберегти зміни",
    "button_more"                    => "Більше",
    "button_select_all"              => "Вибрати все",
